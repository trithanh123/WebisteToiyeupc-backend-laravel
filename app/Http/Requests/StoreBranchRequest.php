...
class StoreBranchRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'email_chi_nhanh.email' => 'Email chi nhánh không đúng định dạng, vui lòng kiểm tra lại.',
        ];
    }
